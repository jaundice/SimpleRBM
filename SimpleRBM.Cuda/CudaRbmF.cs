...
{
    public class CudaRbmF : IRestrictedBoltzmannMachine<TElement>, IDisposable
    {
        ...
        public CudaRbmF(GPGPU gpu, GPGPURAND rand, int numVisible, int numHidden, int layerIndex, TElement[,] weights,
