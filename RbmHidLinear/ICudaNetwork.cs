...
namespace CudaNN
{
        ...
        where TElement : struct, IComparable<TElement>
    {
        ...
        Matrix2D<TElement> ReconstructWithLabels(Matrix2D<TElement> data, out Matrix2D<TElement> labels, bool softmaxLabels =true);
        ...
        Matrix2D<TElement> DaydreamWithLabels(int numDreams, out Matrix2D<TElement> labels, bool guassian = true, bool softmaxLabels = true);
