...
namespace CudaNN.DeepBelief.LayerBuilders
{
    public class ConstructNewLayer : ConstructLayerBase
    {
        ...
        public static readonly DependencyProperty MomentumIncrementStepProperty =
            DependencyProperty.Register(" MomentumIncrementStep", typeof (TElement),
        ...
        public TElement MomentumIncrementStep
        {
            get { return Dispatcher.InvokeIfRequired(() => (TElement) GetValue(MomentumIncrementStepProperty)).Result; }
            set { Dispatcher.InvokeIfRequired(() => SetValue(MomentumIncrementStepProperty, value)).Wait(); }
        }
